...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h1-10 items-center justify-center rounded-lg p-1 gap-2 lg:gap-0 text-muted-foreground lg:border border-navy-opacity-16 typo_variant_button',
      className
    )}
    {...props}
  />
